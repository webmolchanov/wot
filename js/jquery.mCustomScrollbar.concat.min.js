    ...
    !(function (t) {
        ...
        var o = "mCustomScrollbar",
            ...
            r = {
                ...
                advanced: { autoScrollOnFocus: "input,textarea,select,button,datalist,keygen,a[tabindex],area,object,[contenteditable='true']", updateOnContentResize: !0, updateOnImageLoad: !0 },
                theme: "light",
                            ...
                            "x" !== i.axis &&
                                (o.overflowed[0]
                                    ? l[0].height() > l[0].parent().height()
                                        ? k.call(this)
                                        : (Q(t, s[0].toString(), { dir: "y", dur: 0, overwrite: "none" }), (o.contentReset.y = null))
                                    : (k.call(this), "y" === i.axis ? O.call(this) : "yx" === i.axis && o.overflowed[1] && Q(t, s[1].toString(), { dir: "x", dur: 0, overwrite: "none" }))),
                                "y" !== i.axis &&
                                    (o.overflowed[1]
                                        ? l[1].width() > l[1].parent().width()
                                            ? k.call(this)
                                            : (Q(t, s[1].toString(), { dir: "x", dur: 0, overwrite: "none" }), (o.contentReset.x = null))
                                        : (k.call(this), "x" === i.axis ? O.call(this) : "yx" === i.axis && o.overflowed[0] && Q(t, s[0].toString(), { dir: "y", dur: 0, overwrite: "none" }))),
                                a &&
                                    o &&
                        ...
                        return e(o).each(function () {
                            ...
                            if (o.data(n)) {
                                ...
                                (c[0] = Y.call(this, c[0], "y")),
                                    ...
                                    (s.dur = d),
                                    setTimeout(function () {
                                        null !== c[0] && "undefined" != typeof c[0] && "x" !== r.axis && i.overflowed[0] && ((s.dir = "y"), (s.overwrite = "all"), Q(o, c[0].toString(), s)),
                                            null !== c[1] && "undefined" != typeof c[1] && "y" !== r.axis && i.overflowed[1] && ((s.dir = "x"), (s.overwrite = "none"), Q(o, c[1].toString(), s));
                                    }, s.timeout);
                            }
                        });
                    }
            ...
            x = function () {
                ...
                "y" === i.axis || i.advanced.autoExpandHorizontalScroll || p.css("width", _(p.children())),
                    "outside" === i.scrollbarPosition ? ("static" === t.css("position") && t.css("position", "relative"), t.css("overflow", "visible"), m.addClass("mCSB_outside").after(c)) : (m.addClass("mCSB_inside").append(c), p.wrap(d)),
                    w.call(this);
            ...
            w = function () {
                var t = e(this),
                    ...
                    l = [
                        "<a href='#' class='" + u[13] + "' oncontextmenu='return false;' " + r + " />",
                        "<a href='#' class='" + u[14] + "' oncontextmenu='return false;' " + r + " />",
                        "<a href='#' class='" + u[15] + "' oncontextmenu='return false;' " + r + " />",
                        "<a href='#' class='" + u[16] + "' oncontextmenu='return false;' " + r + " />",
                    ],
            ...
            B = function (e, t, a) {
                ...
                "active" === t
                    ? (e.toggleClass(u[0] + " " + o), n.toggleClass(u[1]), (e[0]._draggable = e[0]._draggable ? 0 : 1))
                    : e[0]._draggable || ("hide" === t ? (e.removeClass(u[0]), n.removeClass(u[1])) : (e.addClass(u[0]), n.addClass(u[1])));
            },
            T = function () {
                var t = e(this),
                    a = t.data(n),
            ...
            I = function (t) {
                ...
                "x" !== i.axis &&
                    (o.overflowed[0] && !t
                        ? (s[0].add(c[0]).add(s[0].children("a")).css("display", "block"), l.removeClass(u[8] + " " + u[10]))
                        : (i.alwaysShowScrollbar ? (2 !== i.alwaysShowScrollbar && c[0].add(s[0].children("a")).css("display", "none"), l.removeClass(u[10])) : (s[0].css("display", "none"), l.addClass(u[10])), l.addClass(u[8]))),
                    "y" !== i.axis &&
                        (o.overflowed[1] && !t
                            ? (s[1].add(c[1]).add(s[1].children("a")).css("display", "block"), l.removeClass(u[9] + " " + u[11]))
                            : (i.alwaysShowScrollbar ? (2 !== i.alwaysShowScrollbar && c[1].add(s[1].children("a")).css("display", "none"), l.removeClass(u[11])) : (s[1].css("display", "none"), l.addClass(u[11])), l.addClass(u[9]))),
            ...
            E = function () {
                ...
                function o(e, t, a, o) {
                    if (((p[0].idleTimer = f.scrollInertia < 233 ? 250 : 0), i.attr("id") === m[1]))
                        var n = "x",
            ...
            D = function () {
                ...
                var o,
                    ...
                    k = [];
                w
                    .bind("touchstart." + _ + " pointerdown." + _ + " MSPointerDown." + _, function (e) {
                        if (et(e) && !d && !R(e)[2]) {
                            var t = w.offset();
                    ...
                    .bind("touchmove." + _ + " pointermove." + _ + " MSPointerMove." + _, function (e) {
                        if (et(e) && !d && !R(e)[2]) {
                            ...
                            var t = S.offset(),
                                ...
                                r = R(e)[1] - t.left,
                                l = "mcsLinearOut";
                            if ((C.push(n), y.push(r), (k[2] = Math.abs(R(e)[0] - k[0])), (k[3] = Math.abs(R(e)[1] - k[1])), v.overflowed[0]))
                    ...
                    .bind("mousemove." + f, function (e) {
                        if (r && o()) {
                            ...
                            a > 0 && a < m.height() && n > 0 && n < m.width()
                                ...
                                : ("x" !== c.axis && s.overflowed[0] && (0 > a ? i("on", 38) : a > m.height() && i("on", 40)), "y" !== c.axis && s.overflowed[1] && (0 > n ? i("on", 37) : n > m.width() && i("on", 39)));
                        }
                    })
                ...
                l.bind("focusin." + r, function () {
                    ...
                    o.is(i.advanced.autoScrollOnFocus) &&
                        ...
                        (t[0]._focusTimeout = setTimeout(function () {
                            ...
                            "x" === i.axis || n[0] || Q(t, e[0].toString(), { dir: "y", scrollEasing: "mcsEaseInOut", overwrite: c, dur: r }),
                                "y" === i.axis || n[1] || Q(t, e[1].toString(), { dir: "x", scrollEasing: "mcsEaseInOut", overwrite: c, dur: r });
                        }, t[0]._focusTimer)));
                });
            },
            H = function () {
            ...
            q = function (t, a, o, i, r) {
                function l(e) {
                    ...
                    return (
                        ...
                        Q(t, g.toString(), { dir: f.dir[0], scrollEasing: v, dur: o, onComplete: x }),
                        e
                            ? void (f.dir = !1)
                            : (clearTimeout(f.step),
            ...
            j = function (t) {
                ...
                return (
                    ...
                    t instanceof Array ? (o = t.length > 1 ? [t[0], t[1]] : "x" === a.axis ? [null, t[0]] : [t[0], null]) : ((o[0] = t.y ? t.y : t.x || "x" === a.axis ? null : t), (o[1] = t.x ? t.x : t.y || "y" === a.axis ? null : t)),
                        ...
                        (h[0].autoUpdate = setTimeout(function () {
                            return d.advanced.updateOnSelectorChange && ((m = r()), m !== S)
                                ...
                                : (d.advanced.updateOnContentResize &&
                                      ...
                                      (p[0] !== w[0] || p[1] !== w[1] || p[2] !== w[2] || p[3] !== w[3] || p[4] !== w[4] || p[5] !== w[5]) && (l(p[0] !== w[0] || p[1] !== w[1]), (w = p))),
            ...
            Q = function (t, a, o) {
                ...
                if (
                    ...
                    "_resetY" !== a || s.contentReset.y || (i("onOverflowYNone") && c.callbacks.onOverflowYNone.call(t[0]), (s.contentReset.y = 1)),
                    "_resetX" !== a || s.contentReset.x || (i("onOverflowXNone") && c.callbacks.onOverflowXNone.call(t[0]), (s.contentReset.x = 1)),
                    "_resetY" !== a && "_resetX" !== a)
                ) {
                    switch (
                    ...
                    w[1] < 0 || (0 === w[0] && 0 === w[1]) ? (w = [0, 0]) : w[1] >= S[1] ? (w = [S[0], S[1]]) : (w[0] = -w[0]),
                        ...
                        (s.tweenRunning || !((0 === _ && w[0] >= 0) || (_ === S[0] && w[0] <= S[0]))) &&
                                    ...
                                    if (o.callbacks && o.onComplete) {
                                        ...
                                        h[0].onCompleteTimeout = setTimeout(function () {
                                            i("onScroll") && (l(), c.callbacks.onScroll.call(t[0])),
                                                i("onTotalScroll") && w[1] >= S[1] - y && s.cbOffsets[0] && (l(), c.callbacks.onTotalScroll.call(t[0])),
                                                i("onTotalScrollBack") && w[1] <= T && s.cbOffsets[1] && (l(), c.callbacks.onTotalScrollBack.call(t[0])),
                                                (s.tweenRunning = !1),
                                                (h[0].idleTimer = 0),
                                                B(v, "hide");
                                        }, e);
